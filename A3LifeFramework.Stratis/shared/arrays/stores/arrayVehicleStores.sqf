...
Format:
[ownerObj, [[VehiclesToSell, StockLevel, intMaxStock]], [AccessArray], themeName, StoreName, spawnMarkerName, boolHasMarker];
...
_Array_Store_Vehicles = [
	// -- Car stores
	[CarStoreCiv1, [["c_offroad", 30, 50], ["B_Quadbike_F", 75, 100]], [civilian], "CivStore", localize "STR_MV_STORES_CARSTORECIV1", "CarStoreCiv1_Spawn", true],
    [CarStoreCop1, [["B_Hunter_F", 45, 50], ["B_Quadbike_F", 75, 100]], [west], "CopStore", localize "STR_MV_Stores_CarStoreCop1", "CarStoreCop1_Spawn", false],
    // -- Boat Stores
...
if (isServer) then 
{
	...
	(call M_C_fnc_GLV) setVariable ["Array_Store_Vehicles", _Array_Store_Vehicles];
};
