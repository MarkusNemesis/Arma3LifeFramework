...
Array_Items = [
	...
	['Small Spare Tyre Kit', 5, 250, [1, 0.25, 15], 'MV_Client_fnc_Use_TestUse', "Replaces a small land vehicle's wheels with flimsy replacements for temporary use.", 'Land_Sack_F'], // Args: Repair scale 1 (vehicle size), repair coverage (0.1 = wheels) and repair time 15s
	['Light Repair Kit', 5, 400, [1, 0.25, 15], 'MV_Client_fnc_Use_RepairKitUse', 'Repairs small land and sea vehicles to running condition. Use only for cursory repairs.', 'Land_Sack_F'] // Args: Repair scale 1 (vehicle size), repair coverage (0.25 = fuel, engine, wheels) and repair time 15s
]; // End array