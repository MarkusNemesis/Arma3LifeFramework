...
_Array_Items = [
	...
	['Zip-cuffs', 				100, 	3, 		[false, "p", 60],		'MV_Client_fnc_Use_HandCuffUse', 						"A simple pair of plastic, disposable, zip-tie hand cuffs. Used for restraining people en-masse. Whether legally, or illegally. You're pretty sure someone could work their way out of these pretty quickly if you took your eye off them for just a moment; Especially if they had a knife, or a pair of toddler safety scissors."]   // Args: boolhasLock, strCuffMaterial, intRestrainTime
	['Handcuffs', 				350, 	55,		[true, "m", 180],		'MV_Client_fnc_Use_HandCuffUse', 						"A sturdy metal pair of conventional hand-cuffs. Fitted with a picky lock, these things don't look all that easy to get out of. Let's just hope no-one loses the key."]   // Args: boolhasLock, strCuffMaterial, intRestrainTime
]; // End array
