...
Array_Store_Vehicles = [
	[CarStoreCiv1, [["c_offroad", 30], ["B_Quadbike_F", 100]], [str civilian], "CivStore", "Jamie's Used Autos"],
    [CarStoreCop1, [["B_Hunter_F", 45]], [str west], "CopStore", "UN Vehicle Quartermaster"]
];
